...
|---|---|---|---:|---|
| ChatGPT replica 01/02/04 | `chatgpt_space` | `chatgpt_space_default` | 540s | في live smoke الأخير نجح text/search في 01 و02. أرسلنا صورة واحدة فقط لكل نسخة؛ كلاهما أعاد HTTP 200 مع `images=[]` ورسالة Free plan image quota، لذلك image=deferred until quota reset. يوجد دليل تاريخي سابق على PNG صالح من 02. replica-04 تُظهر زر login مرئيًا حقيقيًا بحجم 68.2×36 وتفشل بإشارة re-authentication سريعة. كل Space له Storage State خاص خارج Git. |
